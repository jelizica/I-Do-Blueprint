...
/// Preview section showing imported vendor data
struct VendorImportPreviewView: View {
    ...
    var body: some View {
        VStack(spacing: Spacing.lg) {
            ...
            if let validation = validationResult {
                VendorImportValidationSection(validation: validation)
            } else if isImporting {
                HStack {
                    ProgressView()
                        .scaleEffect(0.8)
...
struct VendorImportValidationSection: View {
